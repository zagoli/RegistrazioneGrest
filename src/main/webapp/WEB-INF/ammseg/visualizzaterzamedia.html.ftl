        ...
        <table class="table table-hover table-responsive nowrap" id="t_ter">
            ...
            <#list terzamedia as ter>
                <tr>
                    ...
                    <td>
                        <a href="javascript:;"
                           onClick="window.open('/RegistrazioneGrest/App/InfoDettaglio?target=infoter&id=${ter[0].id}', 'Dettagli terzamedia', 'width=600, height=700, status, scrollbars=1, location');"><img
                                    src="../img/octicons/search.svg" alt="dettaglio"></a>
                        <a href="/RegistrazioneGrest/App/ModificaTerzamedia?id=${ter[0].id}"><img
                                    src="../img/octicons/pencil.svg" alt="modifica"></a>
                        <a href="/RegistrazioneGrest/App/EliminaTerzamedia?id=${ter[0].id}"><img
                                    src="../img/octicons/trashcan.svg" alt="elimina"></a>
                    </td>
                    ...
                    <td><#if ter[0].saNuotare><img src="../img/octicons/check.svg" alt="si"><#else><img
                                src="../img/octicons/x.svg" alt="no"></#if></td>
                    <td><#if ter[0].festaPassaggio><img src="../img/octicons/check.svg" alt="si"><#else><img
                                src="../img/octicons/x.svg" alt="no"></#if></td>
                    <td><#if ter[0].richieste??><img src="../img/octicons/check.svg" alt="presenti"><#else>
                            <img src="../img/octicons/x.svg" alt="assenti"></#if></td>
                    <td><#if ter[0].noteAlimentari??><img src="../img/octicons/check.svg"
                                                          alt="presenti"><#else><img
                                src="../img/octicons/x.svg" alt="assenti"></#if></td>
                    <td><#if ter[1]??>${ter[1].quota}&euro;<#else><img src="../img/octicons/x.svg"
                                                                       alt="assente"></#if></td>
                </tr>
            </#list>
            </tbody>
