...
<div class="container-fluid mt-5 content">
    <div class="container shadow pt-2 pl-3 pr-3 pb-2 bg-white">
        <#if attivita??>
            ...
            <p class="text-center mt-4">è possibile collaborare in più di una attività! Ripetere il procedimento
                precedente per dare la propria disponibilità in altri ambiti.</p>
        <#else>
            <p class="text-center">Per dare la tua disponibilità a collaborare, scegli innanzitutto dalla lista il tipo
                di attività che ti interessa, poi scrivi opzionalmente un periodo in cui sei disponibile, quindi clicca
                invia.</p>
            <hr/>
        </#if>
