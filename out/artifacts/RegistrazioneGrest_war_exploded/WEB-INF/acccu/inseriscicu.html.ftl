        ...
        <div class="shadow pt-2 pl-3 pr-3 pb-2 bg-white">
            ...
            <form action="/RegistrazioneGrest/App/InserisciCU" method="POST" data-parsley-validate>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" required id="relazione" name="relazione" placeholder="Relazione" data-parsley-length="[2, 40]"> 
                </div>
                <div class="form-group">
                    <label for="cellulare"> Telefono cellulare </label> 
                    <input class="form-control" type="text" id="cellulare" name="cellulare" placeholder="Cellulare" data-parsley-length="[10, 10]"> 
                </div>
                <div class="form-group">
                    <label for="fisso"> Telefono fisso </label> 
                    <input class="form-control" type="text" id="fisso" name="fisso" placeholder="Fisso" data-parsley-length="[10, 10]"> 
                </div>
