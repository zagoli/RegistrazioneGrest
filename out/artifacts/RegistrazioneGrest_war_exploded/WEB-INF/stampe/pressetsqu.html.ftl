...
<#include "../struct/header.html.ftl">
    <div class="mt-4 content">
        <h2 class="text-uppercase text-center"> presenze settimanali ${squadra}</h2>
        <h5 class="text-uppercase text-center font-italic">settimana numero ${settimana.idSettimana} <small>(dal ${settimana.daQuando} al ${settimana.aQuando})</small></h5>
        <div class="container">
